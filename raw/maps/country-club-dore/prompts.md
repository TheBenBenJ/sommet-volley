...
8. Nomme : `raw/maps/country-club-dore/<nom>.png`  
...
2. Cutout **props only** ; re-copie skyline/far/crowd/thumb si le script les a touchés :
   `cp raw/maps/country-club-dore/{skyline,far,crowd_0,thumb}.png assets/maps/country-club-dore/`
3. Mesurer `baselineFromBottom` → `MAP_LAYOUT.plage` (terrainKey `plage` → pack `dorf`).
