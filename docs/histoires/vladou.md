...
> Clé roster : `vladou` · Nation : **Bourassie** · Super : **Hiver Général** · Map : **Place Écarlate** (idx 0) · Event : canon d'apparat
...
// ===================== ACTE I — L'entente froide (Volley) =====================
{
  ...
  left: "vladou", right: "panda", terrain: 4, mode: "volley", ai: 0, doped: null,
  pre: [
    ...
    { s: "panda", t: "Bienvenue, voisin du Nord. Ici, l'harmonie a un tempo. Le tien est un peu… glacé." },
    { s: "vladou", t: "Le froid ne discute pas, il attend. Comme toi. Nous nous ressemblons plus que nos drapeaux ne l'admettent." },
    { s: "panda", t: "Un partenariat 'sans limites', disent nos communiqués. Sans limites, sauf celles que je décide." },
    { s: "vladou", t: "Joli. Tu bâtis des murailles, je gèle les fronts. Servons, et voyons quelle patience craque la première." },
    { s: "narrator", t: "Match d'apparat entre alliés qui se surveillent. Sourires longs, comptes précis." }
  ],
  win: [
    { s: "vladou", t: "Le gel prend même l'harmonie, à la longue. Beau match, camarade de circonstance." },
    { s: "panda", t: "Un set. Le tempo est long. Je te laisse le Nord ; je prends le siècle." }
  ],
  lose: [
    { s: "panda", t: "La patience du panda gèle plus fort que ton hiver. L'harmonie corrige toujours." },
    { s: "vladou", t: "Suspension temporaire. Rien n'est perdu quand on a des fuseaux horaires en réserve." }
  ]
},
{
  act: 1, title: "Le radar et le manteau", sub: "Bourassie–Ryonganie · le protégé nucléaire",
  left: "vladou", right: "bebe", terrain: 3, mode: "volley", ai: 1, doped: null,
  pre: [
    ...
    { s: "vladou", t: "Range ta parade, petit. Garde le carburant. Tu m'envoies des caisses, je t'envoie du blé. On appelle ça l'amitié moderne." },
    { s: "bebe", t: "Ma Batterie AA t'interdit de sauter chez moi ! Personne ne saute chez le Maréchal !" },
    { s: "vladou", t: "Je n'ai pas besoin de sauter. Je reste au sol, et le sol vient à moi. Allume ton radar, il ne verra que de la neige." },
    { s: "narrator", t: "Le radar tourne. Le manteau du Tsar ne bouge pas." }
  ],
  win: [
    { s: "vladou", t: "Bon petit. Continue de fournir, continue de fanfaronner. L'un compense l'autre." },
  ...
  lose: [
    ...
    { s: "vladou", t: "Profite, gamin. Un jour tu comprendras qui tient la clé du carburant. Ce jour-là, tu défileras plus doucement." }
  ]
},
{
  act: 1, title: "Le baril et la rose", sub: "Bourassie–Ramenie · pétro-partenaires sanctionnés",
  left: "vladou", right: "safran", terrain: 9, mode: "volley", ai: 1, doped: null,
  pre: [
    ...
    { s: "vladou", t: "Tu vends discret, je vends au rabais, l'Ouest fulmine et achète quand même. L'hypocrisie a un bon rendement." },
    { s: "safran", t: "Mon Voile d'Or ralentit tes gestes. La patience, tu connais ; la lenteur, tu vas l'apprendre." },
    { s: "vladou", t: "Ralentis-moi tant que tu veux. Je suis déjà l'hiver. Personne ne va plus lentement que la banquise, et pourtant elle avance." },
    { s: "narrator", t: "Volley feutré entre alliés de contrainte. Chacun compte les barils de l'autre." }
  ],
  win: [
    { s: "vladou", t: "Belle roseraie. Continue de me couvrir les flancs, je te couvrirai au conseil. Entre parias, on se tient chaud." },
  ...
  lose: [
    ...
    { s: "vladou", t: "Un revers entre amis. Rien de grave. Sers-moi encore du thé, et parlons de nos ennemis communs." }
  ]
},
...
// ===================== ACTE II — Tensions régionales (montée) =====================
{
  ...
  left: "vladou", right: "yogi", terrain: 6, mode: "volley", ai: 1, doped: null,
  pre: [
    ...
    { s: "yogi", t: "Namasté, ami du froid. Le monde te boude, et moi je t'achète ton pétrole au rabais. La neutralité est un yoga." },
    { s: "vladou", t: "Le seul qui reste debout quand tout le monde choisit un camp. Souple. Presque bourassien." },
    { s: "yogi", t: "Ma Méditation gèle ton camp façon zen. Tu gèles par la peur ; moi, par la sérénité. Même patinoire, autre température d'âme." },
    { s: "vladou", t: "Zen ou glace, le résultat est le même : l'autre ne bouge plus. Servons, gourou. La vache attend, elle." },
    { s: "narrator", t: "Deux immobilités s'affrontent. La plus froide gagnera. Ou la plus calme." }
  ],
  win: [
    { s: "vladou", t: "L'hiver bat la méditation quand la méditation ferme les yeux. Continue d'acheter, ami neutre." },
    { s: "yogi", t: "Un revers m'enseigne. Respirons. Je reviendrai, et j'aurai encore besoin de ton gaz." }
  ],
  lose: [
    { s: "yogi", t: "Le calme absorbe le gel. Namasté, Tsar. La montagne ne prend pas parti, et pourtant elle gagne." },
    { s: "vladou", t: "Match nul pour l'histoire, victoire pour toi. Garde ta neutralité. Elle m'arrange plus que la tienne." }
  ]
},
{
  act: 2, title: "Le blé et l'ara", sub: "Bourassie–Tropicalia · céréales, engrais, populisme",
  left: "vladou", right: "jair", terrain: 7, mode: "volley", ai: 2, doped: null,
  pre: [
    ...
    { s: "jair", t: "Alors le Tsar ! On me vend ton engrais, ton blé, ta nostalgie de fer. Ici on aime les gars qui parlent fort et taillent le bois !" },
    { s: "vladou", t: "Tu abats des arbres, je gèle des fronts. Deux façons de faire du vide et d'appeler ça de la grandeur." },
    { s: "jair", t: "Ma Déforestation te dresse un mur de troncs ! Bon courage pour geler ça, l'ami du Nord !" },
    { s: "vladou", t: "Un mur de bois ? J'en fais du gel qui craque. Le tien tombe ; le mien reste. Sers, capitaine." },
    { s: "narrator", t: "Populistes des deux hémisphères. L'un vend le grain, l'autre le rugit." }
  ],
  win: [
    { s: "vladou", t: "Le froid porte plus loin que la tronçonneuse. Continue de m'acheter mes engrais, tribun." },
    { s: "jair", t: "Truqué ! Fraude ! … Bon, remets-moi une cargaison, on oublie. Entre durs, on se comprend." }
  ],
  lose: [
    { s: "jair", t: "HA ! La forêt a bouffé l'hiver ! Le Capitaine plante un ballon en pleine banquise ! On coupe, on gagne !" },
    { s: "vladou", t: "Tu gagnes une manche et tu coupes tes propres poumons. Chacun sa méthode pour se refroidir." }
  ]
},
{
  act: 2, title: "L'avion abattu", sub: "Bourassie–Bosforie · l'incident du détroit",
  left: "vladou", right: "sultan", terrain: 5, mode: "bomb", ai: 2, doped: null,
  pre: [
    ...
    { s: "vladou", t: "Tu contrôles le détroit, moi le robinet. Tant qu'on a besoin l'un de l'autre, la mèche brûle lentement." },
    { s: "sultan", t: "Mon Séisme te secoue et t'interdit de sauter ! Sur mon pont, c'est MOI qui fais trembler la terre !" },
    { s: "vladou", t: "Tremble tant que tu veux. Le gel, lui, ne saute pas : il glisse. Et il glisse toujours vers ton camp." },
    { s: "narrator", t: "Ne laisse pas la bombe de ton côté. Entre le froid et le séisme, une seule mèche décidera." }
  ],
  win: [
    { s: "vladou", t: "Le sang-froid éteint la mèche. On reste amis, Sultan — amis qui gardent un doigt sur le robinet." },
  ...
  lose: [
    ...
    { s: "vladou", t: "Grandiose, comme toujours. Profite. Le gaz continue de couler, et l'hiver a de la mémoire." }
  ]
},
...
// ===================== ACTE III — Grands duels de l'Ouest (Bombe) =====================
{
  ...
  left: "vladou", right: "trompette", terrain: 1, mode: "volley", ai: 2, doped: null,
  pre: [
    ...
    { s: "trompette", t: "Le Tsar ! Un type fort. Très fort. Les gens disent qu'il est fort. On s'entend super bien, tout le monde en parle." },
    { s: "vladou", t: "Tu bâtis un Mur d'or, je bâtis l'hiver. Deux hommes qui adorent bloquer le camp d'en face. Presque touchant." },
    { s: "trompette", t: "Ton hiver, ton hiver… moi j'ai le plus beau gazon du monde et un Mur en OR. De l'or ! Ça brille plus que ta neige !" },
    { s: "vladou", t: "L'or fond, ami. La neige revient. Devine lequel de nous deux joue la longue partie." },
    { s: "narrator", t: "Volley de flatteries. Chacun croit tenir l'autre en laisse. Les analystes, eux, ne dorment plus." }
  ],
  win: [
    { s: "vladou", t: "Bon match, associé. Continue de te vanter ; ça me laisse le temps de préparer l'hiver." },
    { s: "trompette", t: "Truqué ! Mais élégamment truqué. On refait ça au sommet, entre gars forts. Les plus forts !" }
  ],
  lose: [
    { s: "trompette", t: "GAGNÉ ! Le plus grand match de tous les temps ! J'ai battu le Tsar ! Personne n'avait jamais fait ça, personne !" },
    { s: "vladou", t: "Savoure, associé. Je préfère te laisser la coupe et garder la partie. C'est plus chaud pour toi, plus utile pour moi." }
  ]
},
{
  act: 3, title: "Le faucon dans la neige", sub: "Bourassie–Levantie · fronts croisés",
  left: "vladou", right: "faucon", terrain: 8, mode: "bomb", ai: 3, doped: "R",
  pre: [
    ...
    { s: "vladou", t: "Intransigeant jusqu'à l'os. J'aime. Ça rend le froid plus utile. Toi tu frappes vite, moi je frappe tard." },
    { s: "faucon", t: "Mon Raid Éclair t'interdit de sauter chez moi. Frappe préventive : je ne laisse pas l'hiver arriver." },
    { s: "vladou", t: "Frappe avant, si tu veux. On ne devance pas une saison. Elle arrive de toute façon, et elle te trouve fatigué." },
    { s: "narrator", t: "Le rapace se dope à l'enjeu. Renvoie la bombe. Ne laisse jamais la mèche finir dans ton camp." }
  ],
  win: [
    { s: "vladou", t: "Le raid s'essouffle, l'hiver dure. Tu es rapide, faucon. Moi, je suis inévitable." },
  ...
  lose: [
    ...
    { s: "vladou", t: "Rapide, brutal, précis. Et pressé. C'est ta faiblesse : tu comptes en secondes, je compte en siècles." }
  ]
},
{
  act: 3, title: "Le dégel n'aura pas lieu", sub: "Bourassie–Gallardie · le grand front de l'Ouest",
  left: "vladou", right: "micron", terrain: 0, mode: "bomb", ai: 3, doped: "R",
  pre: [
    ...
    { s: "micron", t: "En même temps, un ennemi, ça se combat ET ça se parle. Je suis venu jusque sur ta place, Tsar. Le dialogue et le contre." },
    { s: "vladou", t: "Chez moi. Sous ma neige. Tu parles, tu proposes, tu tends la main… et moi j'attends que le froid réponde à ta place." },
    { s: "micron", t: "Ton Passage en Force, tes fronts gelés, ton canon décoratif… La Gallardie ne cédera pas un pouce de gazon." },
    { s: "vladou", t: "Ton Passage en Force à toi empêche mes smashes ? Parfait. Je n'ai pas besoin de smasher. J'ai besoin que tu aies froid." },
    { s: "micron", t: "En même temps… il fait vraiment très froid ici. Servons avant que je ne sente plus mes doigts." },
  ...
  win: [
    { s: "vladou", t: "Le canon a parlé, l'hiver a répondu. Rentre au Palais du Coq, Cygne. Dis-leur que la neige, elle, ne négocie pas." },
    { s: "vladou", t: "J'ai gelé tous les fronts, un par un, sans jamais courir. On appelle ça la patience. Vous appelez ça un problème." },
    { s: "micron", t: "Ce n'est pas une fin, c'est un front de plus. La diplomatie est un sport d'endurance — et l'endurance, je la garde." }
  ],
  lose: [
    { s: "micron", t: "Le dégel a eu lieu. Sur ta propre place, sous ton propre canon. En même temps, il fallait bien que quelqu'un rallume le printemps." },
    { s: "vladou", t: "Une manche perdue chez moi. Je ne concède pas : je suspends. L'hiver, contrairement à ta victoire, reviendra. Il revient toujours." }
  ]
}
```
