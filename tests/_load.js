...
;module.exports = {
  ...
  padMergeGameInput: typeof padMergeGameInput === "function" ? padMergeGameInput : null,
  padGameInput: typeof padGameInput === "function" ? padGameInput : null,
  setPadsNow: arr => { padsNow = arr || []; padConnected = !!(padsNow && padsNow.length); },
  parseControlMarkup: typeof parseControlMarkup === "function" ? parseControlMarkup : null,
  canOpenPauseMenu: typeof canOpenPauseMenu === "function" ? canOpenPauseMenu : null,
  openPauseMenu: typeof openPauseMenu === "function" ? openPauseMenu : null,
  resumeFromPause: typeof resumeFromPause === "function" ? resumeFromPause : null,
  ...
  canHitBallThroughNet: typeof canHitBallThroughNet === "function" ? canHitBallThroughNet : () => true,
  isBallGhostBlob: typeof isBallGhostBlob === "function" ? isBallGhostBlob : () => false,
  clearNextTouchers: typeof clearNextTouchers === "function" ? clearNextTouchers : () => {},
  ...
  goMenu: typeof goMenu === "function" ? goMenu : null,
  menuDemoWanted: typeof menuDemoWanted === "function" ? menuDemoWanted : null,
  tickMenuDemo: typeof tickMenuDemo === "function" ? tickMenuDemo : null,
  startMenuDemoMatch: typeof startMenuDemoMatch === "function" ? startMenuDemoMatch : null,
  getMenuDemo: () => (typeof menuDemo !== "undefined" ? menuDemo : null),
  startTutorial: typeof startTutorial === "function" ? startTutorial : null,
  getTutorialMode: () => (typeof tutorialMode !== "undefined" ? !!tutorialMode : false),
  getTutorialStep: () => (typeof tutorialStep !== "undefined" ? tutorialStep | 0 : 0),
  setTutorialStep: v => { if (typeof tutorialStep !== "undefined") tutorialStep = v | 0; },
  setTutorialStepShownAt: v => {
    if (typeof tutorialStepShownAt !== "undefined") tutorialStepShownAt = v | 0;
  },
  ...
  getNetConnected: () => !!netConnected,
  setNetConnected: v => { netConnected = !!v; },
  onConnClosed: typeof onConnClosed === "function" ? onConnClosed : null,
  getNetErrorMsg: () => (typeof netErrorMsg !== "undefined" ? netErrorMsg : ""),
  getVsAI: () => !!vsAI,
